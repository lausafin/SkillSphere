...
var CategoriesController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/categories'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var CategoriesController = _classThis = /** @class */ (function () {
        ...
        CategoriesController_1.prototype.create = function (req, createCategoryDto) {
        ...
        CategoriesController_1.prototype.findAll = function (req) {
            return this.categoriesService.findAll(req.user.userId);
        };
        CategoriesController_1.prototype.findOne = function (req, id) {
            return __awaiter(this, void 0, void 0, function () {
                var category;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.categoriesService.findOne(req.user.userId, id)];
                        case 1:
                            category = _a.sent();
                            if (!category) {
        ...
        //@UsePipes(new ValidationPipe({ whitelist: true })) // Uncomment if using class DTOs
        CategoriesController_1.prototype.update = function (req, id, updateCategoryDto) {
            return this.categoriesService.update(req.user.userId, id, updateCategoryDto);
        };
        CategoriesController_1.prototype.remove = function (req, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: 
                        // Service method throws NotFound or Forbidden if needed
                        return [4 /*yield*/, this.categoriesService.remove(req.user.userId, id)];
                        case 1:
                            // Service method throws NotFound or Forbidden if needed
                            _a.sent();
                            return [2 /*return*/];
