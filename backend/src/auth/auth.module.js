...
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy], // Provide JwtStrategy so AuthGuard can use it
            exports: [auth_service_1.AuthService, jwt_1.JwtModule], // Export if needed elsewhere
        })];
