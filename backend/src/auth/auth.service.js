    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.validateUser = function (email, pass) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a, passwordHash, result;
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, name, saltRounds, hashedPassword, newUser, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            email = registerDto.email, password = registerDto.password, name = registerDto.name;
                            saltRounds = 10;
