...
export class SkillsController {
    ...
    getPersonalSkillProgressSummary(@Request() req): Promise<SkillProgressSummaryDto> {
      console.log('🧠 [GET /progress-summary] req.user =', req.user);
      console.log('📦 Full req.headers =', req.headers);
